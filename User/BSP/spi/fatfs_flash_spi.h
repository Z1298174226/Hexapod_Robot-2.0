...
#define SPI_FLASH_CS_LOW()      GPIO_ResetBits(GPIOA, GPIO_Pin_4)				//输出低电平 GPIO_ResetBits(FLASH_CS_GPIO_PORT, FLASH_CS_PIN)
#define SPI_FLASH_CS_HIGH()     GPIO_SetBits(GPIOA, GPIO_Pin_4)			  //设置为高电平 GPIO_SetBits(FLASH_CS_GPIO_PORT, FLASH_CS_PIN)
